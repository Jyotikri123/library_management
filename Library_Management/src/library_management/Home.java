...
public class Home extends JFrame implements ActionListener {
	...
	public Home() {
		...
		lblNewLabel_3.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/fourth.png"));
		...
		lblNewLabel_3_1.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/third.png"));
		lblNewLabel_3_1.setBackground(SystemColor.text);
		lblNewLabel_3_1.setBounds(293, 121, 176, 159);
		contentPane.add(lblNewLabel_3_1);
		
		JLabel lblNewLabel_3_2 = new JLabel("");
		lblNewLabel_3_2.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/sixth.png"));
		lblNewLabel_3_2.setBackground(Color.BLACK);
		lblNewLabel_3_2.setBounds(60, 408, 159, 159);
		contentPane.add(lblNewLabel_3_2);
		
		JLabel lblNewLabel_3_3 = new JLabel("");
		lblNewLabel_3_3.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/tenth.png"));
		lblNewLabel_3_3.setBackground(Color.BLACK);
		lblNewLabel_3_3.setBounds(293, 408, 159, 159);
		contentPane.add(lblNewLabel_3_3);
		
		JLabel lblNewLabel_3_4 = new JLabel("");
		lblNewLabel_3_4.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/seventh.png"));
		lblNewLabel_3_4.setBackground(Color.BLACK);
		lblNewLabel_3_4.setBounds(570, 408, 159, 159);
		contentPane.add(lblNewLabel_3_4);
                
                
//                ImageIcon background = new ImageIcon(ClassLoader.getSystemResource("icons/seventh.jpg"));
//                Image i5 = background.getImage().getScaledInstance(159,159,Image.SCALE_SMOOTH);
//                ImageIcon i6 = new ImageIcon(i5);
//                JLabel profile = new JLabel(i6);
//                profile.setBounds(570,408, 159, 159);
//		contentPane.add(profile);
//                
                
		
		JLabel lblNewLabel_3_2_1 = new JLabel("");
		lblNewLabel_3_2_1.setIcon(new ImageIcon("/Users/jyoti/Desktop/Project/Library_Management/src/library_management/icons/second.png"));
